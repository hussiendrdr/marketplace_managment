...
return[
    ...
    "Foiling Effect"=>"Foiling Effect",
    "Embossing Effect"=>"Embossing Effect",
    "Spot UV Effect"=>"Spot UV Effect",
    "offset printing"=>"offset printing",
    "flexo printing "=>"flexo printing ",
    "Paper Cup Lid"=>"Paper Cup Lid",
    "PP material"=>"PP material",
    "PS material"=>"PS material",
    "White Color"=>"White Color",
    "Black Color"=>" Black Color",
    "Clear Color"=>"Clear Color",
    "Sip Lid"=>"Sip Lid",
    "Reclosable Lid"=>"Reclosable Lid",
    "PET"=>"PET",
    "Classic model"=>"Classic model",
    "U-Shaped model"=>"U-Shaped model ",
    "Plastic Cup Lid"=>"Plastic Cup Lid",
    "Flat"=>"Flat",
    "Dome"=>"Dome",
    "Semi-Dome"=>"Semi-Dome",
    ...
    'Flat Handle'=>"Flat Handle",
    "Punched-Out Handle"=>"Punched-Out Handle",
    ...
    "printing_cliché"=>"printing_cliché",//////////////////////
    "f_flute"=>"f_flute",
    "e_flute"=>"e_flute",
    "b_flute"=>"b_flute",
    "c_flute"=>"c_flute",
    ...
    "Customer Attatchment C.R"=>"Customer Attatchment C.R ? is this file",
