        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('lang.Customer')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    @lang('lang.edit this customer')</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form action="{{route('customer.update',$customer->id)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                            <div class="col">
                                <label for="customer_contact_number" class="control-label">@lang('lang.Number')</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="customer_contact_number2" class="control-label">@lang('lang.Customer Contact number2')</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="website" class="control-label">@lang('lang.website')</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="customer_attatchment_CR" class="control-label">@lang('lang.Customer Attatchment C.R') </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="color_codes_pantone" class="control-label">@lang('lang.Customer Codes antone / CMYK')</label>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="text" class="btn btn-primary">@lang('lang.update')</button>
                        </div>
