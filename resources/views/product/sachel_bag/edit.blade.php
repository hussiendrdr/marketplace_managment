...
@section('content')
    ...
    <div class="row prod">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('SachelBag.update',$product->id)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @method('PUT')
                        @csrf
                        {{-- 1 --}}
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="text-danger">Upload Only ( pdf, jpeg , png ) @lang('lang.files')</p>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" value="{{$sachelBag->material_type}}" name="material_type" placeholder="quantity" class="form-control">
                            </div>
                            <div class="col">
                                <label for="material_color" class="control-label">@lang('lang.Material Colors')</label>
                                <input type="text" value="{{$sachelBag->material_color}}" name="material_color" placeholder="quantity" class="form-control">
                            </div>
                        </div>
                        <br>
                        {{-- 4 --}}
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select  name="print_type" class="form-control">
                                    <!--placeholder-->
                                    <option value="Full" {{$sachelBag->print_type =="Full" ? 'selected' : ''}}>Full</option>
                                    <option value="Partial" {{$sachelBag->print_type =="Partial" ? 'selected' : ''}}>Partial</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="pe_layer">PE @lang('lang.Layer')</label>
                            ...
                            <div class="col">
                                <label for="pe_layer_thickness">PE @lang('lang.Layer Thickness')</label>
